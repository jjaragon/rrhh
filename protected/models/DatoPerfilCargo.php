...
/**
 * This is the model class for table "dato_perfil_cargo".
 *
 * The followings are the available columns in table 'dato_perfil_cargo':
 ...
 */
class DatoPerfilCargo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('registro, componente_id, campo_id, cargo_id, contenido', 'required'),
			...
			array('sw_estado, sw_aplica', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('item_id, registro, componente_id, campo_id, cargo_id, contenido, registro_perfil, sw_estado, especificacion_id, sw_aplica', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'cruceComponentesItems' => array(self::HAS_MANY, 'CruceComponentesItems', 'item_id'),
	 ...
	 * @return DatoPerfilCargo the static model class
	 */
