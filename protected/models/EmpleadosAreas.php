...
/**
 * This is the model class for table "empleados_areas".
 *
 * The followings are the available columns in table 'empleados_areas':
 * @property integer $empleado_area_id
 ...
 */
class EmpleadosAreas extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('empleado_id, area_id, sw_estado, fecha_registro, user_registra', 'required'),
			array('empleado_id, user_registra', 'numerical', 'integerOnly'=>true),
			array('sw_estado', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('empleado_area_id, empleado_id, area_id, sw_estado, fecha_registro, user_registra', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'empleado_area_id' => 'Empleado Area',
	...
	public function search()
	{
		...
		$criteria->compare('empleado_area_id',$this->empleado_area_id);
	 ...
	 * @return EmpleadosAreas the static model class
	 */
